...
class neuralNetwork :
    ...
    def __int__(self,inputnodes,hiddennodes,outnodes,learningrate) :
        ...
        self.who = numpy.random.normal(0.0,pow(self.onodes,-0.5),(self.ondes,self.hnodes))
        
        self.1r = learningrate
        
        self.activation_function = lambda x: scipy.special.expit(x)
        pass
    
    
    def train(self,imputs_list,targets_list) :
...
#将文件导入列表
training_data_file = open("C:\Users\daxiguammm\Documents\Tencent Files\2277493107\FileRecv", 'r') 
...
#将文件导入列表
test_data_file = open("E:\pzy的学习文档\python 神经网络\ML_PG\test_30", 'r') 
